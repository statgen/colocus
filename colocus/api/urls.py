...
urls_v1 = [
    ...
    path(
        "signals/<uuid>/",
        views.FinemappedSignalDetailView.as_view(),
        name="signals-detail",
    ),
    path(
        "signals/<uuid>/region/",
    ...
    path(
        "analysis/<uuid>/",
        views.MarginalAnalysisDetailView.as_view(),
    ...
    path(
        "submissions/", views.DataSubmissionListView.as_view(), name="submissions-all"
    ),
    path(
        "submissions/<uuid>/",
        views.DataSubmissionDetailView.as_view(),
