...
class Person(models.Model):
    ...
    orcid = models.TextField(
        help_text="ORCID of the analyst", null=False, blank=False, unique=True
    )

    name = models.TextField(
        help_text="Name of the analyst", null=False, blank=False, unique=False
    )

    email = models.EmailField(
        help_text="Email address of the analyst", null=False, blank=False, unique=False
    )

    institution = models.TextField(
        help_text="Institution of the analyst", null=True, blank=True, unique=False
    )
...
class Gene(models.Model):
    ens_id = models.TextField(
        null=False, blank=False, db_index=True, unique=True, help_text="Ensembl ID"
    )

    symbol = models.TextField(
        null=False, blank=False, db_index=True, help_text="HGNC symbol"
    )
    chrom = models.TextField(null=True, blank=False, help_text="Chromosome")
    start = models.PositiveIntegerField(
        null=True, blank=False, help_text="Start position of the gene"
    )
    end = models.PositiveIntegerField(
        null=True, blank=False, help_text="End position of the gene"
    )
...
class Exon(models.Model):
    ...
    chrom = models.TextField(null=True, blank=False, help_text="Chromosome")
    start = models.PositiveIntegerField(
        null=True, blank=False, help_text="Start position of the exon"
    )
    end = models.PositiveIntegerField(
        null=True, blank=False, help_text="End position of the exon"
    )
...
class MethylProbe(models.Model):
    ...
    pos = models.PositiveIntegerField(
        null=True, blank=False, help_text="Position of the methylation probe"
    )
...
class Protein(models.Model):
    ...
    chrom = models.TextField(null=True, blank=False, help_text="Chromosome")
    start = models.PositiveIntegerField(
        null=True, blank=False, help_text="Start position of the protein sequence"
    )
    end = models.PositiveIntegerField(
        null=True, blank=False, help_text="End position of the protein sequence"
    )
...
class Trait(models.Model):
    ...
    gene = models.ForeignKey(
        Gene, on_delete=models.CASCADE, related_name="trait", null=True
    )

    exon = models.ForeignKey(
        Exon, on_delete=models.CASCADE, related_name="trait", null=True
    )

    protein = models.ForeignKey(
        Protein, on_delete=models.CASCADE, related_name="trait", null=True
    )

    methyl_probe = models.ForeignKey(
        MethylProbe, on_delete=models.CASCADE, related_name="trait", null=True
    )

    metabolite = models.ForeignKey(
        Metabolite, on_delete=models.CASCADE, related_name="trait", null=True
    )

    phenotype = models.ForeignKey(
        Phenotype, on_delete=models.CASCADE, related_name="trait", null=True
    )
...
class Publication(models.Model):
    ...
    title = models.TextField(
        blank=True, null=True, help_text="Title of the publication"
    )
    ...
    journal = models.TextField(
        blank=True, null=True, help_text="Journal of publication"
    )
...
class FineMappedSignal(models.Model):
    ...
    cs_variants = models.JSONField(
        default=list, help_text="List of variants in this signal's credible set."
    )
...
class BaseColocResult(models.Model):
    ...
    r2 = models.FloatField(
        null=True, help_text="R2 between the two signals' lead variants"
    )
