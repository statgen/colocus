...
Extracted from PheWeb: 2cfaa69, with modifications based on locuszoom-hosted ce49e94f to use -log10p

(it would be nice to deduplicate code, but...)
"""
...
def generate_qq(in_filename: str, out_filename) -> bool:
    ...
    variants = list(augment_variants(reader))
