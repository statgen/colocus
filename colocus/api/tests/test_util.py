...
b = [
    ...
    BasicVariant(
        "12", 5, None, "A", "G", 21, 1, 2, 2
    ),  # multiallelic at position-sorted in different order than a
    BasicVariant("12", 5, None, "A", "C", 22, 1, 2, 2),
    BasicVariant(
        "12", 9, None, "A", "C", 23, 1, 2, 2
    ),  # not in a (need to advance both a and b at different times)
]
